...
python3 extract_new_encoding.py \
                 --train_path "${HOME}/datasets/amazon_multimodal/train.csv"  \
                 --val_path "${HOME}/datasets/amazon_multimodal/val.csv"  \
                 --output_dir "${HOME}/datasets/amazon_multimodal/new-encoding/${w}x${w}-${encoding_height}-sep${ste_separator_size}-spixel${ste_superpixel_size}" \
