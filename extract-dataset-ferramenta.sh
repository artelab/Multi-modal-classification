...
#                         --train_path "/home/superior/datasets/ferramenta52-multimodal/train.csv"  \
#                         --val_path "/home/superior/datasets/ferramenta52-multimodal/val.csv"  \
#                         --output_dir "/home/superior/datasets/ferramenta52-multimodal/new_encoding/${w}x${w}-${encoding_height}" \
...
python3 extract_new_encoding.py \
                 --train_path "/home/superior/datasets/ferramenta52-multimodal/train.csv"  \
                 --val_path "/home/superior/datasets/ferramenta52-multimodal/val.csv"  \
                 --output_dir "/home/superior/datasets/ferramenta52-multimodal/new_blank_encoding/${w}x${w}-${encoding_height}-sep${ste_separator_size}-spixel${ste_superpixel_size}" \
                 --output_image_width $w \
                 --encoding_height $encoding_height \
                 --save_model_dir_name "runs/ferramenta52-$w-$encoding_height" \
                 --gpu_id "" \
