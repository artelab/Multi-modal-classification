...
python3 extract_new_encoding.py \
                 --train_path "${HOME}/datasets/food-101/train.csv"  \
                 --val_path "${HOME}/datasets/food-101/test.csv"  \
                 --output_dir "${HOME}/datasets/food-101/new-encoding/${w}x${w}-${encoding_height}-sep${ste_separator_size}-spixel${ste_superpixel_size}" \
